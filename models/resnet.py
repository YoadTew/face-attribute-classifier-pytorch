...
def resnet18_old(pretrained=False, progress=True, **kwargs):
...
def resnet50_old(pretrained=False, progress=True, **kwargs):
...
def test():
    net = resnet18(pretrained=True, num_classes=7)
